...
|-------|-------------|-------------|
| [makepad-basics](https://github.com/ZhangHanDong/makepad-skills/tree/main/skills/makepad-basics) | App structure, `live_design!`, `app_main!` | "Create a new Makepad app" |
| [makepad-dsl](https://github.com/ZhangHanDong/makepad-skills/tree/main/skills/makepad-dsl) | DSL syntax, inheritance, prototypes | "How to define widgets in DSL" |
| [makepad-layout](https://github.com/ZhangHanDong/makepad-skills/tree/main/skills/makepad-layout) | Flow, sizing, spacing, alignment | "Center a widget", "Arrange elements" |
| [makepad-widgets](https://github.com/ZhangHanDong/makepad-skills/tree/main/skills/makepad-widgets) | Common widgets, custom widgets | "Create a button", "Build a form" |
| [makepad-event-action](https://github.com/ZhangHanDong/makepad-skills/tree/main/skills/makepad-event-action) | Event handling, actions | "Handle click events" |
| [makepad-animation](https://github.com/ZhangHanDong/makepad-skills/tree/main/skills/makepad-animation) | Animator, states, transitions | "Add hover animation" |
| [makepad-shaders](https://github.com/ZhangHanDong/makepad-skills/tree/main/skills/makepad-shaders) | Shaders, SDF, gradients, visual effects | "Custom visual effects" |
| [makepad-platform](https://github.com/ZhangHanDong/makepad-skills/tree/main/skills/makepad-platform) | Platform support | "Build for Android/iOS" |
| [makepad-font](https://github.com/ZhangHanDong/makepad-skills/tree/main/skills/makepad-font) | Font, text, typography | "Change font, text styling" |
| [makepad-splash](https://github.com/ZhangHanDong/makepad-skills/tree/main/skills/makepad-splash) | Splash scripting language | "Dynamic UI scripting" |

#### Robius Patterns (5 Skills)

| Skill | Description | When to Use |
|-------|-------------|-------------|
| [robius-app-architecture](https://github.com/ZhangHanDong/makepad-skills/tree/main/skills/robius-app-architecture) | Tokio, async/sync patterns | "Structure an async app" |
| [robius-widget-patterns](https://github.com/ZhangHanDong/makepad-skills/tree/main/skills/robius-widget-patterns) | Reusable widgets, `apply_over` | "Create reusable components" |
| [robius-event-action](https://github.com/ZhangHanDong/makepad-skills/tree/main/skills/robius-event-action) | Custom actions, `MatchEvent` | "Custom event handling" |
| [robius-state-management](https://github.com/ZhangHanDong/makepad-skills/tree/main/skills/robius-state-management) | AppState, persistence | "Save/load app state" |
| [robius-matrix-integration](https://github.com/ZhangHanDong/makepad-skills/tree/main/skills/robius-matrix-integration) | Matrix SDK integration | "Chat client features" |

#### MolyKit (1 Skill)

| Skill | Description | When to Use |
|-------|-------------|-------------|
| [molykit](https://github.com/ZhangHanDong/makepad-skills/tree/main/skills/molykit) | AI chat, SSE streaming, `BotClient` | "AI chat integration" |
...
#### [makepad-deployment](https://github.com/ZhangHanDong/makepad-skills/blob/main/skills/makepad-deployment/SKILL.md) - Build & Package

Build for desktop (Linux, Windows, macOS), mobile (Android, iOS), and web (WebAssembly).

#### [makepad-reference](https://github.com/ZhangHanDong/makepad-skills/blob/main/skills/makepad-reference/SKILL.md) - Reference Materials
...
#### [evolution](https://github.com/ZhangHanDong/makepad-skills/blob/main/skills/evolution/SKILL.md) - Self-Improvement
