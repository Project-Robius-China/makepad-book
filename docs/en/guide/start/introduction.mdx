...
>
> Simple example: [https://github.com/acyanbird/makepad-book-simple](https://github.com/acyanbird/makepad-book-simple) This repository provides the complete code for the demo used in this tutorial.
